...
class SystemEvent(TypedDict):
    ...
    count: int
    average_queue_length: float
    queue_lengths_by_platform: Dict[str, List[float]]
    available_memory_by_node: Dict[str, List[float]]
    available_platforms_by_node: Dict[str, List[int]]
...
scheduling_strategies: Dict[str, str] = {
    ...
    "baas_baas": "BAAS-BAAS",
    "steplearn_steplearn": "STEPLEARN-STEPLEARN"
}
