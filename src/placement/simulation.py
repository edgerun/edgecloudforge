...
from src.policy.baas.autoscaler import BaasKnativeAutoscaler
from src.policy.baas.orchestrator import BaasKnativeOrchestrator
from src.policy.baas.scheduler import BaasKnativeScheduler
...
from src.policy.steplearn.autoscaler import StepLearnKnativeAutoscaler
from src.policy.steplearn.orchestrator import StepLearnKnativeOrchestrator
from src.policy.steplearn.scheduler import StepLearnKnativeScheduler
...
def start_simulation(
    ...
    policies: Dict[
        ...
        "prohetkn_prohetkn": (
        HeteroProactiveKnativeOrchestrator, HeteroProactiveKnativeAutoscaler, HeteroProactiveKnativeScheduler),
        "baas_baas": (BaasKnativeOrchestrator, BaasKnativeAutoscaler, BaasKnativeScheduler),
        "steplearn_steplearn": (StepLearnKnativeOrchestrator, StepLearnKnativeAutoscaler, StepLearnKnativeScheduler)
    }
