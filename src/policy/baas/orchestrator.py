...
from src.policy.baas.model import BaasKnativeSystemState, BaasKnativeSchedulerState
...
class BaasKnativeOrchestrator(Orchestrator):
    def initialize_state(self) -> BaasKnativeSystemState:
        # Initialize scheduler state
        scheduler_state = BaasKnativeSchedulerState(
        ...
        system_state = BaasKnativeSystemState(
    ...
    def monitor_process(self):
        ...
        while True:
            ...
            system_state: BaasKnativeSystemState = yield self.mutex.get()
            replicas: Dict[str, Set[Tuple[Node, Platform]]] = system_state.replicas
            state: BaasKnativeSchedulerState = system_state.scheduler_state
