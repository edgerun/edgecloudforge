...
from src.policy.steplearn.model import StepLearnKnativeSystemState, StepLearnKnativeSchedulerState
...
class StepLearnKnativeOrchestrator(Orchestrator):
    def initialize_state(self) -> StepLearnKnativeSystemState:
        # Initialize scheduler state
        scheduler_state = StepLearnKnativeSchedulerState(
        ...
        system_state = StepLearnKnativeSystemState(
    ...
    def monitor_process(self):
        ...
        while True:
            ...
            system_state: StepLearnKnativeSystemState = yield self.mutex.get()
            replicas: Dict[str, Set[Tuple[Node, Platform]]] = system_state.replicas
            state: StepLearnKnativeSchedulerState = system_state.scheduler_state
